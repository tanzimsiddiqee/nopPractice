...
namespace Nop.Plugin.Widgets.OwlCarousel2.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// </remarks>
        public static CacheKey PICTURE_URL_MODEL_KEY = new("Nop.plugins.widgets.owlcarousel2.pictureurl-{0}-{1}", PICTURE_URL_PATTERN_KEY);
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.owlcarousel2";
